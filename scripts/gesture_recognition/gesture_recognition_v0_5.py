...
def image_callback(msg) :
    ...
    #if not ret:
    #    break
    image = flipped_frame  # Mirror display
    ...
    if results.multi_hand_landmarks is not None:
        for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
            ...
            pub.publish(keypoint_classifier_labels[hand_sign_id])
            rospy.loginfo(keypoint_classifier_labels[hand_sign_id])
...
# initializing rosnode called 'gesture_recognition'
